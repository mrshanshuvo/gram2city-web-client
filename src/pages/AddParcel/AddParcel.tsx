      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {step === 1 && (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => setStep(2)}
                    className="w-full h-12 bg-[#1E5AA8] text-white rounded-2xl font-black text-sm flex items-center justify-center gap-2 hover:bg-[#2E7D32] transition-colors shadow-lg shadow-blue-500/20"
                  >
                ...
                >
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      type="button"
                      onClick={() => setStep(3)}
                      className="flex-1 h-12 bg-[#1E5AA8] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-[#2E7D32] transition-colors shadow-lg shadow-blue-500/20"
                    >
                ...
                >
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 h-12 bg-[#1E5AA8] hover:bg-[#2563eb] text-white rounded-2xl font-black text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-500/10 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
          ...
          <div className="space-y-4">
            <div className="bg-[#1E5AA8] text-white rounded-3xl p-6 shadow-xl shadow-blue-900/20 sticky top-24">
          ...
          <div className="relative z-10">
            ...
            <div className="px-8 pb-8 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#1E5AA8]">
                    Pickup From
                  </h4>
                  <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 space-y-2">
                    ...
                    <div className="pt-2 border-t border-gray-100 flex items-center gap-2">
                      <FiMapPin className="text-[#1E5AA8] shrink-0" size={12} />
                ...
                {/* Delivery Section */}
                <div className="space-y-3">
                  <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#2E7D32]">
                    Deliver To
                  </h4>
                  <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 space-y-2">
                    ...
                    <div className="pt-2 border-t border-gray-100 flex items-center gap-2">
                      <FiUser className="text-[#2E7D32] shrink-0" size={12} />
                      <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wide">
              ...
              <div className="bg-blue-50 border-2 border-blue-100 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-center sm:text-left">
                  <p className="text-[10px] font-bold text-[#1E5AA8] uppercase tracking-wider mb-1">
                    Estimated Cost
                  </p>
                ...
                <div className="text-4xl font-bold text-[#1E5AA8] tracking-tight">
                  ৳{liveCost}
                </div>
              </div>
            </div>
            ...
            <DialogFooter className="px-8 pb-8 pt-0 sm:justify-end gap-3">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="h-14 px-10 bg-[#1E5AA8] hover:bg-[#2563eb] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-xl shadow-blue-900/10 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
                    <span className="loading loading-spinner loading-sm" />
