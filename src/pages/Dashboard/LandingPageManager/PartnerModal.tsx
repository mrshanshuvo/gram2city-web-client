...
import { X, Save, Building2, Hash, Loader2, Image as ImageIcon } from "lucide-react";
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6">
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  >
                    {previewUrl ? (
                      <img src={previewUrl} className="max-h-20 max-w-[80%] object-contain grayscale group-hover:grayscale-0 transition-all" alt="Logo" />
                    ) : (
              ...
              <div className="pt-6 flex justify-end gap-4">
                ...
                >
                  {isLoading ? "Saving..." : <><Save size={20} /> Save Partner</>}
                </button>
              </div>
            </form>
          </motion.div>
