...
import { FiCheck, FiX, FiInfo, FiBriefcase, FiMail, FiPhone, FiMapPin } from "react-icons/fi";
          ...
          <table className="table w-full">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100">
                <th className="py-6 px-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Business Profile</th>
                <th className="py-6 px-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Legal Info</th>
                <th className="py-6 px-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Status</th>
                <th className="py-6 px-8 text-[10px] font-black uppercase tracking-widest text-right text-gray-400">Actions</th>
              </tr>
            </thead>
                ...
                <tr key={merchant._id} className="hover:bg-gray-50/50 transition-all">
                  <td className="py-6 px-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="font-black text-gray-800">{merchant.businessName}</div>
                  ...
                  <td className="py-6 px-8">
                    <div className="space-y-1">
                      <div className="text-xs font-black text-gray-500 flex items-center gap-2">
                        <span className="px-1.5 py-0.5 bg-gray-100 rounded text-[9px] uppercase">ID</span>
                  ...
                  <td className="py-6 px-8 text-right">
                    <div className="flex justify-end gap-2">
                      {merchant.status === "pending" && (
                        <>
                          <button
                            onClick={() => mutation.mutate({ id: merchant._id, status: "approved" })}
                          ...
                          <button
                            onClick={() => mutation.mutate({ id: merchant._id, status: "rejected" })}
