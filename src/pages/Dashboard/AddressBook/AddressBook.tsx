...
const AddressBook = () => {
  ...
  if (isLoading) return <div className="space-y-8 pb-12"><SkeletonLoader type="card" /><SkeletonLoader type="card" /></div>;
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {addresses.map((addr: any) => (
          <div key={addr._id} className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative group hover:shadow-xl transition-all">
            {addr.isDefault && (
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-xl">
                {addr.label === "Home" ? <FiHome /> : addr.label === "Office" ? <FiBriefcase /> : <FiMapPin />}
              </div>
              <div>
                <h3 className="font-black text-slate-800">{addr.label}</h3>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{addr.district}</p>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-6 border-t border-slate-50">
              <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">{addr.region}</span>
              <button
                onClick={() => {
        ...
        {addresses.length === 0 && (
          <div className="col-span-full py-20 text-center bg-slate-50/50 rounded-[3rem] border border-dashed border-slate-100">
            ...
            <p className="text-slate-300 text-xs mt-1">Save your frequent shipping points for a faster checkout experience.</p>
          </div>
        )}
      </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="form-control">
                  <label className="label text-[10px] font-black text-slate-400 uppercase tracking-widest">Label</label>
                  <select
                ...
                <div className="form-control">
                  <label className="label text-[10px] font-black text-slate-400 uppercase tracking-widest">Recipient Name</label>
                  <input
                    type="text"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-black text-slate-400 uppercase tracking-widest">Phone Number</label>
                <input
                  type="text"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-black text-slate-400 uppercase tracking-widest">Street Address</label>
                <textarea
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="form-control">
                  <label className="label text-[10px] font-black text-slate-400 uppercase tracking-widest">District</label>
                  <input
                    type="text"
                    className="input bg-slate-50 border-none font-bold rounded-xl"
                ...
                <div className="form-control">
                  <label className="label text-[10px] font-black text-slate-400 uppercase tracking-widest">Division/Region</label>
                  <input
                    type="text"
                    className="input bg-slate-50 border-none font-bold rounded-xl"
