...
const MerchantApplication = () => {
  ...
  usePageHeader("B2B Enterprise Application", "Transform your shop into a high-volume logistics partner");

  const { register, handleSubmit, formState: { errors } } = useForm<MerchantFormValues>();
      ...
      <div className="bg-white rounded-[3rem] shadow-sm border border-slate-100 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-12 space-y-8">
            <div>
              <h3 className="text-2xl font-black text-slate-800 tracking-tight">Shop Verification</h3>
              <p className="text-slate-400 font-bold text-xs uppercase tracking-widest mt-1">Official Merchant Enrollment</p>
            </div>

            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {/* Business Name */}
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Business / Shop Name</label>
                ...
                {errors.businessName && <p className="text-rose-500 text-[10px] font-bold ml-2 uppercase">{errors.businessName.message}</p>}
              </div>

              {/* Business Type */}
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Business Category</label>
                <select
              ...
              {/* Contact */}
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Official Contact Number</label>
                <div className="relative">
                  <input
              ...
              {/* Address */}
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Physical Shop Address</label>
                <div className="relative">
                  <textarea
          ...
          <div className="bg-slate-900 p-12 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="space-y-10 relative z-10">
              <div>
                <h4 className="text-3xl font-black tracking-tighter leading-none mb-4">Enterprise <br/>Benefits</h4>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 font-medium">Daily scheduled pickups for bulk shipments.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 font-medium">Cash collection with automated bank transfers.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 font-medium">Dedicated dashboard with advanced analytics.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 relative z-10">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2">Review Process</p>
              <p className="text-xs font-bold text-slate-300">Your application will be vetted by our trade compliance team. Check your notifications for the status update.</p>
            </div>
          </div>
        </div>
      </div>
