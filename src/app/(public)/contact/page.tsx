            ...
            <div className="space-y-4">
              {OFFICE_HOURS.map((h) => (
                <div key={h.day} className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <span className="text-gray-900 font-medium text-sm">{h.hours}</span>
                </div>
              ))}
            </div>
            <div className="mt-8 pt-6 border-t border-gray-100">
              <p className="text-sm text-gray-500 leading-relaxed">
                <span className="font-medium text-gray-700">Average response:</span> Phone calls are
                answered immediately. WhatsApp and email within 2 hours.
              </p>
            </div>
          </motion.div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 text-sm font-medium">{ch.value}</p>
                  </div>
                </div>
                <div className="flex items-center gap-1.5 text-gray-400 group-hover:text-gray-600 transition-colors">
                  <span className="text-xs font-medium hidden sm:inline">{ch.cta}</span>
